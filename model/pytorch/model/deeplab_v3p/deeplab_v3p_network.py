...
class DeeplabV3PNetwork(BasePytorchNetwork):
    ...
    def build(self):
        ...
        """
        self.backbone = BackboneBlock(name="backbone")
        self.backbone.build()
        self.semantic_segmentation_block = DeeplabV3PlusBlock(name="deeplab_v3_plus_block")
        self.semantic_segmentation_block.build()
        self.optimizer = torch.optim.SGD(params=[
            {'params': self.backbone.parameters(), 'lr': 0.1*cfg.MODEL.LEARNING_RATE},
        ...
        self.network_blocks.append(self.backbone)
    ...
    def feed_forward(self):
        ...
        features = self.backbone(self.images)
        prediction = self.semantic_segmentation_block(features)
