...
from model.pytorch.core.attention.polarized_self_attention import PSA
...
class BackboneBlock(BaseBlock):
    ...
    def build(self):
        ...
        """
        self.backbone = resnet50(pretrained=True, replace_stride_with_dilation=[False, False, True],
                                 strict=False, attention_module=PSA)
