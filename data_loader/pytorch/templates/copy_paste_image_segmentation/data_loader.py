...
from data_loader.pytorch.templates.copy_paste_image_segmentation.data_set import DataSet
from data_loader.pytorch.templates.image_segmentation.inference_data_set import InferenceDataSet
