...
from data_loader.pipeline.image.base import Float32er, SimpleInputScaler, Int32er
from data_loader.pipeline.image.shape import ChannelLastToFirst, Rescaler, Padder
from tools.io.raster.rasterio_utils import read_window_path


class InferenceGridDataSet(PytorchDataSet):
    """
    ...
    def __init__(self, files_dictionary, training=True):
        ...
        self.rescaler = Rescaler(cfg.DATA_LOADER.IMAGE_SIZE, cfg.DATA_LOADER.IMAGE_SIZE)
    ...
    def __getitem__(self, index):
        ...
        meta_data["stackable_keys"] = ["file_name", "file_index", "x", "y", "crs", "transform", "width", "height",
                                       "patch_width", "patch_height", "overlap"]
