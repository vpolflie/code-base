...
from data_loader.pytorch.templates.image_classification.data_set import DataSet
from data_loader.pytorch.templates.image_classification.inference_data_set import InferenceDataSet
from data_loader.builder import DATA_LOADERS


@DATA_LOADERS.register_module(name='PYTORCH_IMAGE_CLASSIFICATION')
class ImageClassificationDataLoader(PytorchDataLoader):
    """
    ...
    def __init__(self, data_set_configurations):
        ...
        test_data_set = InferenceDataSet(self.test_file_paths, training=False)
